...
<html lang="en">
  ...
  <body>
      ...
      <div class="container text-center">
        ...
        <div class="row">
          <div class="col-12 col-lg-8 offset-lg-2">
            ...
            <p class="fs-20"><i class="fa fa-map-marker mr-8"></i>Localidad</p>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
              ...
              <p class="lead">Descripcion general del lugar.</p>
              ...
              <h5>Historia</h5>
              <p class="lead">Historia del lugar.</p>
    ...
    <!-- Footer -->
    <footer class="site-footer" id="section-apply">
      <div class="container">
        <div class="row gap-y align-items-center">
          ...
          <div class="col-12 col-lg-6">
            <ul class="nav nav-primary nav-hero">
              ...
              <li class="nav-item">
                <a class="nav-link">Telefono</a>
              </li>
              <li class="nav-item">
                <a class="nav-link">Direccion</a>
              </li>
            </ul>
          </div>
